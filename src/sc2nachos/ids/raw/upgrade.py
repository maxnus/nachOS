"""Raw Upgrades identifiers — the complete catalog from Blizzard's stableid.json.

DO NOT EDIT. Generated by `tools/generate_ids.py`. Curate names in `sc2nachos/ids/upgrade.py` instead.
"""

from sc2nachos.ids._base import ReadableIntEnum


class RawUpgradeId(ReadableIntEnum):
    """Every upgrade id the game defines, named as Blizzard names it."""
