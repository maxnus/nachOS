"""Raw Buffs identifiers — the complete catalog from Blizzard's stableid.json.

DO NOT EDIT. Generated by `tools/generate_ids.py`. Curate names in `sc2nachos/ids/buff.py` instead.
"""

from sc2nachos._enum import ReadableIntEnum


class RawBuffId(ReadableIntEnum):
    """Every buff id the game defines, named as Blizzard names it."""
