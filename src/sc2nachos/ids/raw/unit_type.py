"""Raw Units identifiers — the complete catalog from Blizzard's stableid.json.

DO NOT EDIT. Generated by `tools/generate_ids.py`. Curate names in `sc2nachos/ids/unit_type.py` instead.
"""

from sc2nachos._enum import ReadableIntEnum


class RawUnitTypeId(ReadableIntEnum):
    """Every unit id the game defines, named as Blizzard names it."""
